...
import { MoonIcon, ArrowRightOnRectangleIcon, GlobeAltIcon, ChevronRightIcon, CheckIcon,
        UserGroupIcon, CubeIcon, PresentationChartBarIcon, BriefcaseIcon } from '@heroicons/react/20/solid'
...
const navigation = [
    ...
    { name: "token", href: "/token", icon: CubeIcon },
  ];
...
export default function MobileNavbar() {
  ...
  return (
    <div className="space-y-2 py-6 text-sm">
        {navigation.map((item) => (
            <div key={item.name}>
                <Link href={item.href} className="-mx-3 rounded-lg py-1 px-3 font-semibold
        ...
        <div className="py-2 dark:text-white text-black inline-flex font-semibold">
            ...
            <Menu as="div">
                ...
                >
                <Menu.Items className="absolute left-0 z-50 w-full origin-top-right rounded-md 
                ...
                inset-0 overflow-y-auto">
                    ...
                    return (<Menu.Item key={l}>
                        ...
                        <div className="px-4 py-2 dark:text-white text-gray-700" >
                            <Link href={asPath} locale={l} className="inline-flex w-full" onClick={close}>
