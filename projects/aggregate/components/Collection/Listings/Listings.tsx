        ...
        <div className="mx-auto max-w-7xl border-b border-gray-200 dark:border-gray-700">
            <ul className="flex flex-auto -mb-px text-md font-medium text-center text-white  dark:text-gray-400">
                <li className="mr-2 w-full">
                    <div className="inline-flex p-8 border-b-2 border-transparent rounded-t-lg group">
                      Created 
                      <button type="button" className="text-black bg-yellow-200 rounded-md text-sm p-1 text-left ml-2 inline">256</button>
                    </div>
                </li>
                <li className="mr-2 w-full">
                ...
                <li className="mr-2 w-full">
                    <div className="inline-flex p-8 border-b-2 border-transparent rounded-t-lg group">
                      Owned
                      <button type="button" className="text-black bg-pink-300 rounded-md text-sm p-1 text-left ml-2 inline">16</button>
                    </div>
                </li>
            </ul>
        </div>
