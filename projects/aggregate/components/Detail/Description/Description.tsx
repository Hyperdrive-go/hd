    ...
    return (
      <div className="shadow-2xl">
        ...
        <div className="mx-auto max-w-xs md:max-w-xl lg:max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 pt-12">
          {/* Left */}
          <div className="">
            <div className="grid grid-cols-6 md:gap-4 lg:hidden mb-4 gap-4">
              ...
              <div className="col-start-3 col-end-7 md:col-start-2 md:col-end-4 ">
              ...
              <div className="col-start-1 col-end-6 md:col-start-6 flex-auto space-x-3">
                <FontAwesomeIcon icon={faTwitter} className="md:ml-4 text-white w-6 h-6 inline" />
                <FontAwesomeIcon icon={faDiscord} className="md:ml-4 text-white w-6 h-6 inline" />
              </div>
            </div>
            <Image
          ...
          <div>
            <div className="lg:grid grid-cols-6 gap-4 hidden">
              ...
              <div className="col-start-6 space-x-3">
            ...
            <div className="p-2 lg:mt-8 rounded-xl" style={{backgroundColor: "rgba(0, 0, 0, 0.2)"}}>
              <div className="p-3 text-white">
                ...
                <div className="md:flex lg:py-2">
                  <button type="button" className="text-white bg-red-500 mt-4
                  font-medium rounded-lg text-md lg:text-lg px-6 py-3 md:py-1 lg:px-14 lg:py-2 md:text-left mr-2 w-full md:w-auto text-center">Buy Now</button>
                  <button type="button" className="text-white hover:text-white border-2 border-white mt-4
                  font-medium rounded-lg text-md lg:text-lg px-6 py-3 md:py-1 lg:px-14 lg:py-2 md:text-left mr-2 w-full md:w-auto text-center">Make Offer</button>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-4">
                  ...
                  <div className="bg-white rounded-lg p-2">
                    <p className="text-xs lg:text-sm text-gray-500 mb-1 ml-1">Token ID</p>
