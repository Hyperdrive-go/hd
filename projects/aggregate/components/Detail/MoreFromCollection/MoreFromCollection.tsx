...
export const MoreFromCollection = () => {
    return (
      <div className="bg-black pb-12">
        <h2 className="mx-auto max-w-xs md:max-w-2xl lg:max-w-7xl text-white py-8 text-left text-2xl lg:text-3xl font-bold">
          More from Optichads
        </h2>
        <div className="mx-auto max-w-sm md:max-w-2xl lg:max-w-7xl">
          ...
          >
            {features.map((feature) => (
              ...
              >
                <div className="md:max-w-sm bg-gray-900 rounded-lg pb-4">
                    <div className="pt-4"/>
                    <Image 
