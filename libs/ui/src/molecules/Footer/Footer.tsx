        ...
        <div className="relative md:flex h-36 lg:h-44 pt-6 lg:pt-12">
            ...
            <div className="pt-6 px-4 md:px-0 md:pt-0 md:flex flex-1 justify-center md:justify-end">
              <div>
                ...
                <div className="flex pt-4 md:pt-6 space-x-4 justify-start md:justify-end">
                  <a
                      href={process.env.NEXT_PUBLIC_TWITTER_URL} target="_blank"
                      className="px-4 py-4 rounded-lg bg-blue-900"
                    >
                    <FaTwitter className="h-5 w-5 text-white"/>
                  </a>
                  <a
                      href={process.env.NEXT_PUBLIC_DISCORD_URL} target="_blank"
                      className="px-4 py-4 rounded-lg bg-blue-900"
                    >
            ...
            <div className="items-center">
              <div className="md:flex space-x-4">
                <div className="rounded-md text-sm font-medium text-white py-2 lg:pt-4">
                  @2023 HyperDrive. All rights reserved.
                </div>
              </div>
            </div>
